...
export default async function Home() {
  const data = await getMovies('/discover/movie?with_keywords=256466|267122|281741|321739|165402|155554&with_original_language=ko&include_adult=true&sort_by=primary_release_date.desc', 1);
  return (
